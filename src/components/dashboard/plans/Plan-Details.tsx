...
<path d="M9 16.6875C10.0095 16.6875 11.0092 16.4887 11.9419 16.1023C12.8746 15.716 13.722 15.1497 14.4359 14.4359C15.1497 13.722 15.716 12.8746 16.1023 11.9419C16.4887 11.0092 16.6875 10.0095 16.6875 9C16.6875 7.99046 16.4887 6.99081 16.1023 6.05812C15.716 5.12543 15.1497 4.27797 14.4359 3.56412C13.722 2.85027 12.8746 2.28401 11.9419 1.89768C11.0092 1.51134 10.0095 1.3125 9 1.3125M9 16.6875C7.99046 16.6875 6.99081 16.4887 6.05812 16.1023C5.12543 15.716 4.27797 15.1497 3.56412 14.4359C2.85027 13.722 2.28401 12.8746 1.89768 11.9419C1.51134 11.0092 1.3125 10.0095 1.3125 9C1.3125 7.99046 1.51134 6.99081 1.89768 6.05812C2.28401 5.12543 2.85027 4.27797 3.56412 3.56412C4.27797 2.85027 5.12543 2.28401 6.05812 1.89768C6.99081 1.51134 7.99046 1.3125 9 1.3125M9 16.6875C11.3584 16.6875 12.3663 12.2774 12.3663 9C12.3663 5.72256 11.3584 1.3125 9 1.3125M9 16.6875C6.64165 16.6875 5.63373 12.2774 5.63373 9C5.63373 5.72256 6.64165 1.3125 9 1.3125M1.73958 6.4375H16.2604H1.73958ZM1.73958 11.5625H16.2604H1.73958Z" fill="white" fill-opacity="0.25"/>
<path d="M9 16.6875C10.0095 16.6875 11.0092 16.4887 11.9419 16.1023C12.8746 15.716 13.722 15.1497 14.4359 14.4359C15.1497 13.722 15.716 12.8746 16.1023 11.9419C16.4887 11.0092 16.6875 10.0095 16.6875 9C16.6875 7.99046 16.4887 6.99081 16.1023 6.05812C15.716 5.12543 15.1497 4.27797 14.4359 3.56412C13.722 2.85027 12.8746 2.28401 11.9419 1.89768C11.0092 1.51134 10.0095 1.3125 9 1.3125M9 16.6875C7.99046 16.6875 6.99081 16.4887 6.05812 16.1023C5.12543 15.716 4.27797 15.1497 3.56412 14.4359C2.85027 13.722 2.28401 12.8746 1.89768 11.9419C1.51134 11.0092 1.3125 10.0095 1.3125 9C1.3125 7.99046 1.51134 6.99081 1.89768 6.05812C2.28401 5.12543 2.85027 4.27797 3.56412 3.56412C4.27797 2.85027 5.12543 2.28401 6.05812 1.89768C6.99081 1.51134 7.99046 1.3125 9 1.3125M9 16.6875C11.3584 16.6875 12.3663 12.2774 12.3663 9C12.3663 5.72256 11.3584 1.3125 9 1.3125M9 16.6875C6.64165 16.6875 5.63373 12.2774 5.63373 9C5.63373 5.72256 6.64165 1.3125 9 1.3125M1.73958 6.4375H16.2604M1.73958 11.5625H16.2604" stroke="#121118" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
HTTP
                </button>
...
<path d="M7.5 15.5C3.35059 15.5 0 12.1272 0 8C0 3.85059 3.37278 0.5 7.5 0.5C11.6272 0.5 15 3.87278 15 8C15 12.1272 11.6494 15.5 7.5 15.5ZM7.5 1.29882C3.81657 1.29882 0.798817 4.29438 0.798817 7.97781C0.798817 11.6612 3.79438 14.679 7.5 14.679C11.2056 14.679 14.2012 11.6834 14.2012 7.97781C14.2012 4.29438 11.1834 1.29882 7.5 1.29882Z" fill="url(#paint0_linear_0_5444)"/>
<path d="M10.1608 11.0393C10.0498 11.0393 9.96106 10.995 9.8723 10.9284L7.20958 8.26566C7.14301 8.19909 7.09863 8.08814 7.09863 7.9772V3.11773C7.09863 2.89584 7.27615 2.71832 7.49804 2.71832C7.71993 2.71832 7.89745 2.89584 7.89745 3.11773V7.82187L10.427 10.3515C10.5824 10.5068 10.5824 10.7731 10.427 10.9284C10.3605 10.995 10.2495 11.0393 10.1608 11.0393Z" fill="url(#paint1_linear_0_5444)"/>
<defs>
<linearGradient id="paint0_linear_0_5444" x1="7.5" y1="0.5" x2="7.5" y2="15.5" gradientUnits="userSpaceOnUse">
<stop stop-color="#555555"/>
<stop offset="1" stop-color="#2C2C2C"/>
</linearGradient>
<linearGradient id="paint1_linear_0_5444" x1="8.82108" y1="2.71832" x2="8.82108" y2="11.0393" gradientUnits="userSpaceOnUse">
<stop stop-color="#555555"/>
<stop offset="1" stop-color="#2C2C2C"/>
</linearGradient>
</defs>
          ...
          <div className="p-6 bg-white dark:bg-[#1E2327] rounded-lg ">
            ...
            <div className="grid grid-cols-2 gap-4">
              <p className="text-gray-700 text-xs font-medium dark:text-gray-400">
                Username:{" "}
                <span className="text-xs font-medium ml-3">{plan.username}</span>{" "}
                <button className="text-blue-500 hover:underline text-xs font-medium ml-2">
                <svg width="11" height="11" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M4.25004 0.895874C2.39759 0.895874 0.895874 2.39759 0.895874 4.25004V8.39571C0.895874 8.63734 1.09175 8.83321 1.33337 8.83321C1.575 8.83321 1.77087 8.63734 1.77087 8.39571V4.25004C1.77087 2.88083 2.88083 1.77087 4.25004 1.77087H8.34087C8.5825 1.77087 8.77837 1.575 8.77837 1.33337C8.77837 1.09175 8.5825 0.895874 8.34087 0.895874H4.25004Z" fill="#020611"/>
<path fill-rule="evenodd" clip-rule="evenodd" d="M9.73486 2.96278C7.84431 2.75148 5.90579 2.75148 4.01524 2.96278C3.47666 3.02297 3.04386 3.44682 2.98038 3.98957C2.75616 5.90668 2.75616 7.8434 2.98038 9.76051C3.04386 10.3033 3.47666 10.7271 4.01524 10.7873C5.90579 10.9986 7.84431 10.9986 9.73486 10.7873C10.2734 10.7271 10.7062 10.3033 10.7697 9.76051C10.9939 7.8434 10.9939 5.90668 10.7697 3.98957C10.7062 3.44682 10.2734 3.02297 9.73486 2.96278ZM4.11243 3.83236C5.93839 3.62828 7.81171 3.62828 9.63768 3.83236C9.77613 3.84784 9.88498 3.95733 9.90064 4.09122C10.117 5.94079 10.117 7.80928 9.90064 9.65886C9.88498 9.79275 9.77613 9.90224 9.63768 9.91772C7.81171 10.1218 5.93839 10.1218 4.11243 9.91772C3.97397 9.90224 3.86512 9.79275 3.84946 9.65886C3.63313 7.80928 3.63313 5.94079 3.84946 4.09122C3.86512 3.95733 3.97397 3.84784 4.11243 3.83236Z" fill="#020611"/>
</svg>
              ...
              <p className="text-gray-700 text-xs font-medium dark:text-gray-400">
                Hostname:{" "}
                <span className="text-xs font-medium ml-3">{plan.hostname}</span>{" "}
                <button className="text-blue-500 hover:underline text-xs font-medium ml-2">
                <svg width="11" height="11" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M4.25004 0.895874C2.39759 0.895874 0.895874 2.39759 0.895874 4.25004V8.39571C0.895874 8.63734 1.09175 8.83321 1.33337 8.83321C1.575 8.83321 1.77087 8.63734 1.77087 8.39571V4.25004C1.77087 2.88083 2.88083 1.77087 4.25004 1.77087H8.34087C8.5825 1.77087 8.77837 1.575 8.77837 1.33337C8.77837 1.09175 8.5825 0.895874 8.34087 0.895874H4.25004Z" fill="#020611"/>
<path fill-rule="evenodd" clip-rule="evenodd" d="M9.73486 2.96278C7.84431 2.75148 5.90579 2.75148 4.01524 2.96278C3.47666 3.02297 3.04386 3.44682 2.98038 3.98957C2.75616 5.90668 2.75616 7.8434 2.98038 9.76051C3.04386 10.3033 3.47666 10.7271 4.01524 10.7873C5.90579 10.9986 7.84431 10.9986 9.73486 10.7873C10.2734 10.7271 10.7062 10.3033 10.7697 9.76051C10.9939 7.8434 10.9939 5.90668 10.7697 3.98957C10.7062 3.44682 10.2734 3.02297 9.73486 2.96278ZM4.11243 3.83236C5.93839 3.62828 7.81171 3.62828 9.63768 3.83236C9.77613 3.84784 9.88498 3.95733 9.90064 4.09122C10.117 5.94079 10.117 7.80928 9.90064 9.65886C9.88498 9.79275 9.77613 9.90224 9.63768 9.91772C7.81171 10.1218 5.93839 10.1218 4.11243 9.91772C3.97397 9.90224 3.86512 9.79275 3.84946 9.65886C3.63313 7.80928 3.63313 5.94079 3.84946 4.09122C3.86512 3.95733 3.97397 3.84784 4.11243 3.83236Z" fill="#020611"/>
              ...
              <p className="text-gray-700 text-xs font-medium dark:text-gray-400">
                Password:{" "}
                <span className="text-xs font-medium ml-3">{plan.password}</span>{" "}
                <button className="text-blue-500 hover:underline text-xs font-medium ml-2">
                <svg width="11" height="11" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M4.25004 0.895874C2.39759 0.895874 0.895874 2.39759 0.895874 4.25004V8.39571C0.895874 8.63734 1.09175 8.83321 1.33337 8.83321C1.575 8.83321 1.77087 8.63734 1.77087 8.39571V4.25004C1.77087 2.88083 2.88083 1.77087 4.25004 1.77087H8.34087C8.5825 1.77087 8.77837 1.575 8.77837 1.33337C8.77837 1.09175 8.5825 0.895874 8.34087 0.895874H4.25004Z" fill="#020611"/>
<path fill-rule="evenodd" clip-rule="evenodd" d="M9.73486 2.96278C7.84431 2.75148 5.90579 2.75148 4.01524 2.96278C3.47666 3.02297 3.04386 3.44682 2.98038 3.98957C2.75616 5.90668 2.75616 7.8434 2.98038 9.76051C3.04386 10.3033 3.47666 10.7271 4.01524 10.7873C5.90579 10.9986 7.84431 10.9986 9.73486 10.7873C10.2734 10.7271 10.7062 10.3033 10.7697 9.76051C10.9939 7.8434 10.9939 5.90668 10.7697 3.98957C10.7062 3.44682 10.2734 3.02297 9.73486 2.96278ZM4.11243 3.83236C5.93839 3.62828 7.81171 3.62828 9.63768 3.83236C9.77613 3.84784 9.88498 3.95733 9.90064 4.09122C10.117 5.94079 10.117 7.80928 9.90064 9.65886C9.88498 9.79275 9.77613 9.90224 9.63768 9.91772C7.81171 10.1218 5.93839 10.1218 4.11243 9.91772C3.97397 9.90224 3.86512 9.79275 3.84946 9.65886C3.63313 7.80928 3.63313 5.94079 3.84946 4.09122C3.86512 3.95733 3.97397 3.84784 4.11243 3.83236Z" fill="#020611"/>
              ...
              <p className="text-gray-700 text-xs font-medium dark:text-gray-400">
                Port: <span className="text-xs font-medium ml-3">{plan.port}</span>{" "}
                <button className="text-blue-500 hover:underline text-xs font-medium ml-2">
                <svg width="11" height="11" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M4.25004 0.895874C2.39759 0.895874 0.895874 2.39759 0.895874 4.25004V8.39571C0.895874 8.63734 1.09175 8.83321 1.33337 8.83321C1.575 8.83321 1.77087 8.63734 1.77087 8.39571V4.25004C1.77087 2.88083 2.88083 1.77087 4.25004 1.77087H8.34087C8.5825 1.77087 8.77837 1.575 8.77837 1.33337C8.77837 1.09175 8.5825 0.895874 8.34087 0.895874H4.25004Z" fill="#020611"/>
<path fill-rule="evenodd" clip-rule="evenodd" d="M9.73486 2.96278C7.84431 2.75148 5.90579 2.75148 4.01524 2.96278C3.47666 3.02297 3.04386 3.44682 2.98038 3.98957C2.75616 5.90668 2.75616 7.8434 2.98038 9.76051C3.04386 10.3033 3.47666 10.7271 4.01524 10.7873C5.90579 10.9986 7.84431 10.9986 9.73486 10.7873C10.2734 10.7271 10.7062 10.3033 10.7697 9.76051C10.9939 7.8434 10.9939 5.90668 10.7697 3.98957C10.7062 3.44682 10.2734 3.02297 9.73486 2.96278ZM4.11243 3.83236C5.93839 3.62828 7.81171 3.62828 9.63768 3.83236C9.77613 3.84784 9.88498 3.95733 9.90064 4.09122C10.117 5.94079 10.117 7.80928 9.90064 9.65886C9.88498 9.79275 9.77613 9.90224 9.63768 9.91772C7.81171 10.1218 5.93839 10.1218 4.11243 9.91772C3.97397 9.90224 3.86512 9.79275 3.84946 9.65886C3.63313 7.80928 3.63313 5.94079 3.84946 4.09122C3.86512 3.95733 3.97397 3.84784 4.11243 3.83236Z" fill="#020611"/>
  ...
  <div className="flex">
    {/* Line Numbers */}
    <div className="text-gray-500 text-sm pr-4">
      <div>1</div>
      <div>2</div>
      <div>3</div>
      <div>4</div>
    ...
    <div className="overflow-x-auto max-h-40">
      <pre className="text-sm text-white whitespace-pre-wrap break-words">
        Residential-
        <span className="text-green-400">Www.Catproxies.Com</span>:16666:Quzymgdycnvny94326-Zone-Resi:
