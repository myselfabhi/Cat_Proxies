  ...
  return (
    <DashboardLayout>
      <div className="space-y-8 container px-4 mx-auto">
        {/* Header */}
        <div className="mt-12">
          <h1 className="text-2xl font-semibold text-gray-800 dark:text-gray-200 text-center mb-8">
            Get Your Bonus Rewards
          </h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {bonusData.map((bonus) => (
              <div
                key={bonus.id}
                className="relative flex flex-col items-center text-center p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md hover:shadow-lg transition-shadow"
              >
                {/* Icon */}
                <div className="relative w-20 h-20 sm:w-24 sm:h-24 lg:w-32 lg:h-32 flex items-center justify-center -mt-12">
                  <img
                    src={bonus.icon}
                    alt={bonus.title}
                ...
                <div className="mt-8 space-y-5">
                  <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold text-gray-800 dark:text-gray-200">
                    {bonus.title}
                  </h2>
                  <p className="text-sm lg:text-base text-gray-600 dark:text-gray-400 px-2">
                    {bonus.description}
                  </p>
